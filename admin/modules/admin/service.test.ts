...
const mocks = vi.hoisted(() => ({
  tasks: vi.fn<(_: number | undefined, __?: string) => Promise<any[]>>(),
  taskById: vi.fn<(_: string) => Promise<any>>(),
  taskFlowRuns: vi.fn<(_: string) => Promise<any[]>>(),
  unitFlowRuns: vi.fn<(_: string) => Promise<any[]>>(),
  unitDetail: vi.fn<(_: string) => Promise<any>>(),
  unitResources: vi.fn<(_: string) => Promise<any[]>>(),
  conversationList: vi.fn<(_: any) => Promise<any>>(),
  conversationDetail: vi.fn<(_: string) => Promise<any>>(),
  lessonsList: vi.fn<(_: any) => Promise<any>>(),
  lessonById: vi.fn<(_: string) => Promise<any>>(),
  resourcesByUser: vi.fn<(_: number) => Promise<any[]>>(),
  usersDetail: vi.fn<(_: number | string) => Promise<any>>(),
  usersUpdate: vi.fn<(_: number | string, __: any) => Promise<any>>(),
  usersList: vi.fn<(_: any) => Promise<any>>(),
  unitsList: vi.fn<() => Promise<any[]>>(),
  unitsBasics: vi.fn<() => Promise<any[]>>(),
  healthCheck: vi.fn<() => Promise<any>>(),
}));
