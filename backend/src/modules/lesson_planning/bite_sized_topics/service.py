...
class BiteSizedTopicService(ModuleService):
    ...
    async def create_didactic_snippet(self, topic_title: str, key_concept: str, user_level: str = "beginner", concept_context: str | None = None, learning_objectives: list[str] | None = None, previous_topics: list[str] | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            parsed_snippet["_generation_metadata"] = {"generation_prompt": self._format_messages_for_storage(messages), "raw_llm_response": response.content}
    ...
    def _parse_didactic_snippet(self, content: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"title": str(parsed_data["title"]).strip(), "snippet": str(parsed_data["snippet"]).strip(), "type": parsed_data.get("type", "didactic_snippet"), "difficulty": int(parsed_data.get("difficulty", 2))}
            ...
            return {"title": "Didactic Snippet", "snippet": content.strip(), "type": "didactic_snippet", "difficulty": 2}
    ...
    def _parse_didactic_snippet_fallback(self, content: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"title": title, "snippet": snippet, "type": "didactic_snippet", "difficulty": 2}
        except Exception:
            return {"title": "Didactic Snippet", "snippet": content.strip(), "type": "didactic_snippet", "difficulty": 2}
    ...
    async def create_glossary(self, topic_title: str, concepts: list[str], user_level: str = "beginner", lesson_context: str | None = None, learning_objectives: list[str] | None = None, previous_topics: list[str] | None = None) -> list[dict[str, Any]]:
        ...
        try:
            ...
            generation_metadata = {"generation_prompt": self._format_messages_for_storage(messages), "raw_llm_response": response.content}
    ...
    def _parse_glossary_fallback(self, content: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for i, entry in enumerate(entries, 1):
                ...
                glossary_entry = {"type": "glossary_entry", "number": i}
    ...
    def _parse_socratic_dialogues_fallback(self, content: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for i, section in enumerate(dialogue_sections, 1):
                ...
                dialogue = {"type": "socratic_dialogue", "number": i}
    ...
    def _parse_short_answer_questions_fallback(self, content: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for i, section in enumerate(question_sections, 1):
                ...
                question_data = {"type": "short_answer_question", "number": i}
    ...
    def _parse_multiple_choice_questions_fallback(self, content: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for i, section in enumerate(question_sections, 1):
                ...
                question_data = {"type": "multiple_choice_question", "number": i}
                ...
                # Only add question if it has essential fields
                if question_data.get("question") and question_data.get("choices") and question_data.get("correct_answer"):
                    questions.append(question_data)
