...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_bite_sized_topics_core_concept",
        "bite_sized_topics",
        ["core_concept"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_bite_sized_topics_user_level",
        "bite_sized_topics",
        ["user_level"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["topic_id"],
            ["bite_sized_topics.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_bite_sized_components_topic_id",
        "bite_sized_components",
        ["topic_id"],
        unique=False,
    )
    op.create_index(
        "idx_bite_sized_components_topic_type",
        "bite_sized_components",
        ["topic_id", "component_type"],
        unique=False,
    )
    op.create_index(
        "idx_bite_sized_components_type",
        "bite_sized_components",
        ["component_type"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_bite_sized_components_topic_type", table_name="bite_sized_components"
    )
    op.drop_index(
        "idx_bite_sized_components_topic_id", table_name="bite_sized_components"
    )
