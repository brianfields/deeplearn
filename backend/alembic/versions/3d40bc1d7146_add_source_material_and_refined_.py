...
def upgrade() -> None:
    ...
    op.add_column('bite_sized_topics', sa.Column('source_material', sa.Text(), nullable=True))
    op.add_column('bite_sized_topics', sa.Column('source_domain', sa.String(), nullable=True))
    op.add_column('bite_sized_topics', sa.Column('source_level', sa.String(), nullable=True))
    op.add_column('bite_sized_topics', sa.Column('refined_material', sa.JSON(), nullable=True))
