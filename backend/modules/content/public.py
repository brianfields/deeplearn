...
class ContentProvider(Protocol):
    ...
    async def get_intro_lesson_summary(self, unit_id: str) -> Any | None: ...
    ...
    async def set_unit_task(self, unit_id: str, arq_task_id: str | None) -> ContentService.UnitRead | None: ...
