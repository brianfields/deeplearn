...
async def start_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to start session: {e!s}")
...
async def complete_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to complete session: {e!s}")
...
async def pause_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to pause session: {e!s}")
