...
The backend will add these fields **after** receiving your response. Do NOT include them:
- **id**: Generated as `ex-comp-mc-001`, `ex-comp-mc-002`, etc. for comprehension or `ex-trans-mc-001`, `ex-trans-mc-002`, etc. for transfer, in order.
- **exercise_type**: Automatically set to "mcq" (multiple choice) for all exercises.
