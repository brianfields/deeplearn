...
class LLMProvider(ABC):
    ...
    def _create_llm_request(
        ...
        **kwargs: Any,
        ...
        request_max_tokens = max_tokens if max_tokens is not None else self.config.max_tokens
    ...
    def _update_llm_request_success(
        ...
        llm_request.prompt_tokens = response.prompt_tokens
        llm_request.completion_tokens = response.completion_tokens
        llm_request.cost_estimate = response.cost_estimate
        llm_request.finish_reason = response.finish_reason
