...
export class LearningService {
   ...
   */
  async bulkLoadTopics(
    topicIds: string[]
  ): Promise<Map<string, BiteSizedTopicDetail>> {
  ...
  private async getNextTopicIds(_currentTopicId: string): Promise<string[]> {
